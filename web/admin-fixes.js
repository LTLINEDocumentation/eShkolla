...
// Ky skedar nuk zëvendëson openModule; kështu shmanget rekursioni.
// Aktivizon Kërko / Filtro / Rendit / Pastro në çdo tabelë administrative.
(function(){
  ...
  // Ruaj implementimin e role-modules vetëm për jo-ADMIN.
  // ADMIN merr gjithmonë të dhënat reale nga endpoint-i management.
  ...
  window.bindAdminFilters=function bindAdminFilters(){
    ...
    if(currentUser?.role!=='ADMINISTRATOR'||currentModule==='profile')return;
    ...
    // Çdo hap e lidhur me tabelën aktuale; nuk përdor openModule dhe nuk shkakton cikël.
    ...
    function applyFilters(){
      ...
      rows.forEach(r=>{
        ...
        const filterMatch=!fv||filterIndex<0||r.children[filterIndex]?.textContent.trim()===fv;
