    ...
    fun initialize() {
        connection().use { connection ->
            connection.createStatement().use { statement ->
                ...
                statement.executeUpdate("CREATE TABLE IF NOT EXISTS teachers (id VARCHAR(64) PRIMARY KEY, user_id VARCHAR(64) UNIQUE REFERENCES users(id), full_name VARCHAR(200) NOT NULL, subject_id VARCHAR(64), active BOOLEAN NOT NULL DEFAULT TRUE)")
                statement.executeUpdate("ALTER TABLE teachers ALTER COLUMN subject_id DROP NOT NULL")
